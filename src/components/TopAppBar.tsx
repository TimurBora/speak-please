...
const TopAppBar: React.FC<TopAppBarProps> = ({ title, onMenuClick }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-[60] w-full h-16 bg-[#0d0018]/80 backdrop-blur-xl flex items-center justify-between px-6 border-b border-white/5 shadow-2xl"
      style={{
